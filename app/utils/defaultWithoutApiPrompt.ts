...
- \`"keySkills"\` — a **plain comma-separated list of 6–9 skills, tools, and technologies** this role most relied on (languages, frameworks, libraries, platforms, databases, tools), matching the JD (exact JD spelling), e.g. "FastAPI, Python, React, TypeScript, PostgreSQL, Docker, AWS". **A keyword list ONLY — NOT a sentence, NOT an achievement, NOT what you built.** No verbs, no descriptions, no metrics, no bold, no trailing period. (Different templates show either \`project\` or \`keySkills\`; always provide both.)
